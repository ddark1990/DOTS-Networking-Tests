...
public struct NetCubeSnapshotData : ISnapshotData<NetCubeSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref NetCubeSnapshotData baseline1, ref NetCubeSnapshotData baseline2)
    {
    ...
    public void Deserialize(uint tick, ref NetCubeSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref NetCubeSnapshotData target, float factor)
    {
