...
public class NetCubeGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#endif
        [ReadOnly] public ArchetypeChunkBufferType<NetCubeSnapshotData> ghostSnapshotDataType;
...
#endif
                NetCubeSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<NetCubeSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<NetCubeSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<NetCubeSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<NetCubeSnapshotData>(true),
...
public partial class NetCubeGhostSpawnSystem : DefaultGhostSpawnSystem<NetCubeSnapshotData>
{
    struct SetPredictedDefault : IJobParallelFor
    {
        [ReadOnly] public NativeArray<NetCubeSnapshotData> snapshots;
    ...
    protected override JobHandle SetPredictedGhostDefaults(NativeArray<NetCubeSnapshotData> snapshots, NativeArray<int> predictionMask, JobHandle inputDeps)
    {
